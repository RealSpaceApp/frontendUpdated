...
const NavBar = ({setModalVisibleMuteCalls, setModalVisibleRemoveFriend, setModalVisibleMuteEvents}) => {
  ...
  return (
    <View style={[styles.container, styles.profileBackground]}>
      <TouchableOpacity style={styles.iconContainer} onPress={() => setModalVisibleMuteCalls(true)}>
        <Text style={styles.text}>Mute Calls</Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity style={styles.iconContainer} onPress={() => setModalVisibleMuteEvents(true)}>
        <Text style={styles.text}>Mute Events</Text>
      </TouchableOpacity>
    </View>
  );
};
